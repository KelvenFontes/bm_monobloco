...
const Services = () => {
  return (
    <section className="bg-gray-50 p-12 rounded-lg shadow-lg mb-4 mt-4 w-[93%]" id='services'>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2 text-center">Manutenção de Suspensão Geral</h3>
          <p className="text-gray-700 text-center">
            Garantimos a segurança e eficiência do seu veículo com nossa manutenção completa da suspensão.
          </p>
        </motion.div>
        {/* Serviço 4 */}
        <motion.div
